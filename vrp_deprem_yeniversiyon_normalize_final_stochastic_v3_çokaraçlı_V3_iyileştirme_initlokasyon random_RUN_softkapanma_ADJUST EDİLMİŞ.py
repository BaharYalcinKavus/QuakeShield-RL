...
# --- DEPOT ayarları ---
RANDOM_DEPOT_ACTIVE   = False    # True: her senaryoda rastgele depo seç
DEPOT_DEGREE_MIN      = 3
...
FIXED_DEMAND_NODES = [316, 464, 607, 748]#None
...
TARGET_CLOSURE_ACTIVE   = True
CLOSE_TARGET_RANGE      = (0.05, 0.30)  # min%, max% (0.05= %5, 0.15= %15)
...
RISK_MAX_ATTEMPTS = 6
RISK_BASE_RANGE   = (0.00, 1.00)    # hedef kapanma bulunamazsa bu aralıktan r seç
RISK_SOFT_RANGE   = (0.00, 1.00)    # daha da esnek denemeler için
RISK_R_FIXED      = None            # None ise sabit eşik yok; sayı verirsen sabit r
